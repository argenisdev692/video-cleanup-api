        ...
        *,
        ...
        if len(keep_ranges) == 1:
            ...
            command = [
                ...
                '-maxrate',
                settings.render_video_maxrate,
                '-bufsize',
                settings.render_video_bufsize,
                '-pix_fmt',
                'yuv420p',
                '-c:a',
                settings.render_audio_codec,
                '-ar',
                str(settings.render_audio_sample_rate),
                '-ac',
    ...
    def apply_title_overlays(
        ...
        *,
        ...
        command.extend([
            ...
            '-ar', str(settings.render_audio_sample_rate),
            '-ac', str(settings.render_audio_channels),
